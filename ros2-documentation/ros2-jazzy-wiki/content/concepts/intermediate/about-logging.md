...
docname: "Concepts/Intermediate/About-Logging"
...
<a id="logging-and-logger-configuration"></a>
...
- [Logging subsystem design](#logging-subsystem-design)
...
<a id="logging-configuration-environment-variables"></a>
...
- `ROS_HOME` - Control the home directory that is used for various ROS files, including logging and config files.
  ...
  If non-empty, use the contents of this variable for the ROS\_HOME path.
...
| Escape character syntax | Character represented |
| --- | --- |
| `\a` | Alert |
| `\b` | Backspace |
| `\n` | New line |
...
<a id="logging-subsystem-design"></a>

## Logging subsystem design

The image below shows the five main pieces to the logging subsystem and how they interact.

[![ROS 2 logging architecture](../../../assets/images/ros2_logging_architecture.png)](../../../assets/images/ros2_logging_architecture.png)
...
<a id="logging-usage"></a>

## Logging usage

C++

- See the [rclcpp logging demo](https://github.com/ros2/demos/tree/jazzy/logging_demo) for some simple examples.
- See the [logging demo](../../tutorials/demos/logging-and-logger-configuration.md) for example usage.

Python

- See the [rclpy examples](https://github.com/ros2/examples/blob/jazzy/rclpy/services/minimal_client/examples_rclpy_minimal_client/client.py) for example usage of a node’s logger.
- See the [rclpy tests](https://github.com/ros2/rclpy/blob/jazzy/rclpy/test/test_logging.py) for example usage of keyword arguments (e.g. `skip_first`, `once`).
