...
docname: "Tutorials/Advanced/Recording-A-Bag-From-Your-Own-Node-CPP"
...
<a id="recording-a-bag-from-a-node-c"></a>
<a id="ros2bagownnode"></a>
...
Navigate into the `ros2_ws` directory created in a [previous tutorial](../beginner-client-libraries/creating-a-workspace.md#new-directory).
