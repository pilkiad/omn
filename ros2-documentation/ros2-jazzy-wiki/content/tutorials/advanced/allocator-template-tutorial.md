...
docname: "Tutorials/Advanced/Allocator-Template-Tutorial"
...
<a id="implementing-a-custom-memory-allocator"></a>
...
- [Writing an example main](#writing-an-example-main)
- [Passing an allocator to the intra-process pipeline](#passing-an-allocator-to-the-intra-process-pipeline)
- [Testing and verifying the code](#testing-and-verifying-the-code)
- [The TLSF allocator](#the-tlsf-allocator)
...
The code for this tutorial is available [here](https://github.com/ros2/demos/blob/jazzy/demo_nodes_cpp/src/topics/allocator_tutorial_pmr.cpp).
...
The full implementation of the custom allocator for this tutorial is in <https://github.com/ros2/demos/blob/jazzy/demo_nodes_cpp/src/topics/allocator_tutorial_pmr.cpp>.

<a id="writing-an-example-main"></a>
...
<a id="passing-an-allocator-to-the-intra-process-pipeline"></a>
...
<a id="testing-and-verifying-the-code"></a>
...
The [example executable](https://github.com/ros2/demos/blob/jazzy/demo_nodes_cpp/src/topics/allocator_tutorial_pmr.cpp) prints the value of the variables.
...
For more information about TLSF, see [this page via Universitat Politècnica de València](http://www.gii.upv.es/tlsf/).
...
<https://github.com/ros2/realtime_support/blob/jazzy/tlsf_cpp/example/allocator_example.cpp>
