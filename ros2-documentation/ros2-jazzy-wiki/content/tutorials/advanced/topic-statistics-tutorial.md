...
docname: "Tutorials/Advanced/Topic-Statistics-Tutorial/Topic-Statistics-Tutorial"
...
<a id="enabling-topic-statistics-c"></a>
...
- [Tasks](#tasks)
  ...
  - [1 Write the subscriber node with statistics enabled](#write-the-subscriber-node-with-statistics-enabled)

    - [1.1 Examine the code](#examine-the-code)
    - [1.2 CMakeLists.txt](#cmakelists-txt)
  - [2 Build and run](#build-and-run)
  - [3 Observe published statistic data](#observe-published-statistic-data)
- [Summary](#summary)
...
This is a short tutorial on how to enable topic statistics in ROS 2 and view the published statistics output using command line tools ([ros2 topic](../beginner-cli-tools/understanding-ros2-topics.md)).
...
For more details please see the [Topic Statistics Concepts Page](../../concepts/intermediate/about-topic-statistics.md).
...
In previous tutorials, you learned how to [create a workspace](../beginner-client-libraries/creating-a-workspace.md),
[create a package](../beginner-client-libraries/creating-your-first-ros2-package.md), and create a [C++](../beginner-client-libraries/writing-a-simple-cpp-publisher-and-subscriber.md) publisher and subscriber.

This tutorial assumes that you still have your `cpp_pubsub` package from the [C++](../beginner-client-libraries/writing-a-simple-cpp-publisher-and-subscriber.md) tutorial.

<a id="tasks"></a>

## Tasks

<a id="write-the-subscriber-node-with-statistics-enabled"></a>

### 1 Write the subscriber node with statistics enabled

Navigate into the `ros2_ws/src/cpp_pubsub/src` folder, created in the [previous tutorial](../beginner-client-libraries/writing-a-simple-cpp-publisher-and-subscriber.md), and
...
<https://raw.githubusercontent.com/ros2/examples/jazzy/rclcpp/topics/minimal_subscriber/member_function_with_topic_statistics.cpp>
...
As in the [C++](../beginner-client-libraries/writing-a-simple-cpp-publisher-and-subscriber.md) tutorial, we have a subscriber node which receives string messages from the
...
| --- | --- |
| topic\_stats\_options.state | Enable or disable topic statistics (default `rclcpp::TopicStatisticsState::Disable`) |
| topic\_stats\_options.publish\_period | The period in which to collect statistics data and publish a statistics message (default `1s`) |
| topic\_stats\_options.publish\_topic | The topic to use when publishing statistics data (default `/statistics`) |
...
To build, see the [Build and run](../beginner-client-libraries/writing-a-simple-cpp-publisher-and-subscriber.md#cpppubsub-build-and-run) section in the pub/sub tutorial.
...
<a id="observe-published-statistic-data"></a>
...
We can visualize this using [RQt](../../concepts/intermediate/about-rqt.md)

![../../../../_images/topic_stats_rqt.png](../../../assets/images/topic_stats_rqt.png)
...
From the [message definition](https://github.com/ros2/rcl_interfaces/tree/jazzy/statistics_msgs)
the `data_types` are as follows

| data\_type value | statistics |
| --- | --- |
| 1 | average |
| 2 | minimum |
| 3 | maximum |
...
the [C++](../beginner-client-libraries/writing-a-simple-cpp-service-and-client.md)’s publisher node.
...
[ROS 2 Topic Statistics demo](https://github.com/ros2/demos/tree/jazzy/topic_statistics_demo).
