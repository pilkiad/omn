---
title: "Setting up a Reset Handler"
docname: "Tutorials/Advanced/Simulators/Webots/Simulation-Reset-Handler"
...
<a id="setting-up-a-reset-handler"></a>
...
- [Reset Handler for Simple Cases (Controllers Only)](#reset-handler-for-simple-cases-controllers-only)
- [Reset Handler for Multiple Nodes (No Shutdown Required)](#reset-handler-for-multiple-nodes-no-shutdown-required)
- [Reset Handler Requiring Node Shutdown](#reset-handler-requiring-node-shutdown)
- [Summary](#summary)
...
<a id="reset-handler-for-simple-cases-controllers-only"></a>
...
<a id="reset-handler-for-multiple-nodes-no-shutdown-required"></a>
...
<a id="reset-handler-requiring-node-shutdown"></a>
