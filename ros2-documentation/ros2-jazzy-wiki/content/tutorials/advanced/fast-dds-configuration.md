...
docname: "Tutorials/Advanced/FastDDS-Configuration"
...
<a id="unlocking-the-potential-of-fast-dds-middleware-community-contributed"></a>
...
- [Mixing synchronous and asynchronous publications in the same node](#mixing-synchronous-and-asynchronous-publications-in-the-same-node)

  - [Create the node with the publishers](#create-the-node-with-the-publishers)
  - [Create the XML file with the profile configuration](#create-the-xml-file-with-the-profile-configuration)
  - [Execute the publisher node](#execute-the-publisher-node)
  - [Create a node with the subscribers](#create-a-node-with-the-subscribers)
  - [Execute the subscriber node](#execute-the-subscriber-node)
  - [Analysis of the example](#analysis-of-the-example)
- [Using other FastDDS capabilities with XML](#using-other-fastdds-capabilities-with-xml)

  - [Limiting the number of matching subscribers](#limiting-the-number-of-matching-subscribers)
  - [Using partitions within the topic](#using-partitions-within-the-topic)
- [Configuring a service and a client](#configuring-a-service-and-a-client)

  - [Create the nodes with the service and client](#create-the-nodes-with-the-service-and-client)
  - [Create the XML profiles for the service and client](#create-the-xml-profiles-for-the-service-and-client)
  - [Execute the nodes](#execute-the-nodes)

<a id="background"></a>

## Background

The interface between the ROS 2 stack and *Fast DDS* is provided by the ROS 2 middleware implementation [rmw\_fastrtps](https://github.com/ros2/rmw_fastrtps).
...
(see [ROS 2 QoS policies](../../concepts/intermediate/about-quality-of-service-settings.md)).
...
In order to get more information about using *Fast DDS* on ROS 2, please check the [following documentation](https://fast-dds.docs.eprosima.com/en/latest/fastdds/ros2/ros2.html).

<a id="prerequisites"></a>

## Prerequisites

This tutorial assumes that you know how to [create a package](../beginner-client-libraries/creating-your-first-ros2-package.md).
It also assumes you know how to write a [simple publisher and subscriber](../beginner-client-libraries/writing-a-simple-cpp-publisher-and-subscriber.md) and a [simple service and client](../beginner-client-libraries/writing-a-simple-cpp-service-and-client.md).
Although the examples are implemented in C++, the same concepts apply to Python packages.

<a id="mixing-synchronous-and-asynchronous-publications-in-the-same-node"></a>
...
<a id="create-the-node-with-the-publishers"></a>
...
<a id="create-the-xml-file-with-the-profile-configuration"></a>
...
<a id="execute-the-publisher-node"></a>
...
<a id="create-a-node-with-the-subscribers"></a>
...
<a id="execute-the-subscriber-node"></a>
...
<a id="analysis-of-the-example"></a>

### Analysis of the example

<a id="configuration-profiles-xml"></a>
...
<a id="rmw-fastrtps-use-qos-from-xml"></a>

#### RMW\_FASTRTPS\_USE\_QOS\_FROM\_XML
...
<a id="prioritization-of-rmw-qos-profile-t"></a>

#### Prioritization of rmw\_qos\_profile\_t

ROS 2 QoS contained in [rmw\_qos\_profile\_t](http://docs.ros.org/en/jazzy/p/rmw/generated/structrmw__qos__profile__s.html) are always honored, unless set to `*_SYSTEM_DEFAULT`.
...
<a id="using-other-fastdds-capabilities-with-xml"></a>
...
Please refer to [\*Fast DDS\* documentation](https://fast-dds.docs.eprosima.com/en/latest/fastdds/xml_configuration/xml_configuration.html#xml-profiles) to see the whole list of attributes that can be configured through XML files.

<a id="limiting-the-number-of-matching-subscribers"></a>
...
<a id="using-partitions-within-the-topic"></a>
...
<a id="configuring-a-service-and-a-client"></a>
...
<a id="create-the-nodes-with-the-service-and-client"></a>
...
<a id="create-the-xml-profiles-for-the-service-and-client"></a>
