...
docname: "Tutorials/Beginner-Client-Libraries/Writing-A-Simple-Cpp-Publisher-And-Subscriber"
...
<a id="writing-a-simple-publisher-and-subscriber-c"></a>
<a id="cpppubsub"></a>
...
[Nodes](../beginner-cli-tools/understanding-ros2-nodes.md) are executable processes that communicate over the ROS graph.
In this tutorial, the nodes will pass information in the form of string messages to each other over a [topic](../beginner-cli-tools/understanding-ros2-topics.md).
...
The code used in these examples can be found [here](https://github.com/ros2/examples/tree/jazzy/rclcpp/topics).
...
Next, a [lambda function](https://en.cppreference.com/w/cpp/language/lambda) called `timer_callback` is declared.
...
Recall from the [topic tutorial](../beginner-cli-tools/understanding-ros2-topics.md) that the topic name and message type used by the publisher and subscriber must match to allow them to communicate.
...
<a id="cpppubsub-build-and-run"></a>
...
There are several ways you could write a publisher and subscriber in C++; check out the `minimal_publisher` and `minimal_subscriber` packages in the [ros2/examples](https://github.com/ros2/examples/tree/jazzy/rclcpp/topics) repo.
