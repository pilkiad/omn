...
docname: "Tutorials/Intermediate/RViz/RViz-Custom-Display/RViz-Custom-Display"
...
> Related: [Building a Custom RViz Panel](rviz-custom-panel.md) | [Defining worlds, robots, and sensors](../../advanced/simulators/mvsim/defining-worlds-mvsim.md) | [Gazebo](../../advanced/simulators/gazebo/simulation-gazebo.md) | [Getting started with MVSim](../../advanced/simulators/mvsim/getting-started-mvsim.md) | [Installation (macOS)](../../advanced/simulators/webots/installation-mac-os.md)

<a id="building-a-custom-rviz-display"></a>
...
All of the code for this tutorial can be found in [this repository](https://github.com/MetroRobots/rviz_plugin_tutorial).
...
<a id="boilerplate-for-basic-plugin"></a>
...
- [For reasons outside the scope of this tutorial](https://doc.qt.io/qt-5/moc.html), you need the `Q_OBJECT` macro in there to get the QT parts of the GUI to work.
...
<a id="rviz-common-plugins-xml"></a>

### rviz\_common\_plugins.xml
...
[![screenshot of adding display](../../../../assets/images/Step1A.png)](../../../../assets/images/Step1A.png)

Initially, the display will be in an error state because you have yet to assign a topic.

[![screenshot of error state](../../../../assets/images/Step1B.png)](../../../../assets/images/Step1B.png)

If we put the topic `/point` in, it should load fine but not display anything.

[![screenshot of functioning empty display](../../../../assets/images/Step1C.png)](../../../../assets/images/Step1C.png)
...
- `#include <rviz_rendering/objects/shape.hpp>` - There’s [lots of options in the rviz\_rendering package](https://github.com/ros2/rviz/tree/ros2/rviz_rendering/include/rviz_rendering/objects) for objects to build your visualization on.
...
[![screenshot of functioning display](../../../../assets/images/Step2A.png)](../../../../assets/images/Step2A.png)
...
<a id="it-s-nice-to-have-options"></a>

## It’s Nice to Have Options.

If you want to allow users to customize different properties of the visualization, you need to add [rviz\_common::Property objects](https://github.com/ros2/rviz/tree/ros2/rviz_common/include/rviz_common/properties).

You can view the full version of this step with the branch name `step3`.

<a id="header-updates"></a>
...
[![screenshot with color property](../../../../assets/images/Step3A.png)](../../../../assets/images/Step3A.png)

Ooh, pink!

[![screenshot with changed color](../../../../assets/images/Step3B.png)](../../../../assets/images/Step3B.png)
...
[![screenshot with ok status](../../../../assets/images/Step4A.png)](../../../../assets/images/Step4A.png)
[![screenshot with warning status](../../../../assets/images/Step4B.png)](../../../../assets/images/Step4B.png)
...
[[icon source]](https://commons.wikimedia.org/wiki/File:Free_software_icon.svg)
...
[![screenshot with added icon and description](../../../../assets/images/Step5A.png)](../../../../assets/images/Step5A.png)

Here is the display when attempting to add by topic:

[![screenshot with add by topic dialog](../../../../assets/images/Step5B.png)](../../../../assets/images/Step5B.png)

And finally, here’s the icon in the standard interface:

[![screenshot with icon in standard interface](../../../../assets/images/Step5C.png)](../../../../assets/images/Step5C.png)
