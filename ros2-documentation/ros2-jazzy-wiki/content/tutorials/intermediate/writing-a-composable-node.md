...
docname: "Tutorials/Intermediate/Writing-a-Composable-Node"
...
<a id="writing-a-composable-node-c"></a>
...
- [Code Updates](#code-updates)
  ...
  - [Add the Package Dependency](#add-the-package-dependency)
  - [Class Definition](#class-definition)
  - [No More Main Method](#no-more-main-method)
  - [CMake Changes](#cmake-changes)
- [Running Your Node](#running-your-node)

<a id="starting-place"></a>
...
<a id="add-the-package-dependency"></a>

### Add the Package Dependency

Your [package.xml](https://github.com/ros2/demos/tree/jazzy/composition/package.xml) should have a dependency on `rclcpp_components`, a la
...
The only change to your class definition that you may have to do is ensure that [the constructor for the class](https://github.com/ros2/demos/tree/jazzy/composition/src/talker_component.cpp) takes a `NodeOptions` argument.
...
<a id="running-your-node"></a>

## Running Your Node

See the [Composition tutorial](composition.md) for an in-depth look at composing nodes.
