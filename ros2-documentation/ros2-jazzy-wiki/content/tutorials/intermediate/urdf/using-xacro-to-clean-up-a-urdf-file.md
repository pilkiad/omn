---
title: "Using Xacro to clean up your code"
docname: "Tutorials/Intermediate/URDF/Using-Xacro-to-Clean-Up-a-URDF-File"
...
<a id="using-xacro-to-clean-up-your-code"></a>
<a id="urdfxacro"></a>
...
Fortunately, you can use the [xacro](https://index.ros.org/p/xacro) package to make your life simpler.
...
As its name implies, [xacro](https://index.ros.org/p/xacro) is a macro language for XML.
...
An easier way to load the robot model is to use the [urdf\_launch](https://github.com/ros/urdf_launch) package to automatically load the xacro/urdf.
...
Let’s take a quick look at our base\_link in R2D2.
...
- A block can be inserted using the insert\_block command
...
Here are a few useful ways that xacro is used in the [R2D2 model](https://github.com/ros/urdf_tutorial/blob/ros2/urdf/08-macroed.urdf.xacro), in addition to the default inertial macro shown above.
...
- Common Trick 3: Using a reflect parameter, and setting it to 1 or -1.
  See how we use the reflect parameter to put the legs on either side of the body in the base\_to\_${prefix}\_leg origin.
