...
docname: "Tutorials/Intermediate/URDF/Building-a-Visual-Robot-Model-with-URDF-from-Scratch"
...
- [Finishing the Model](#finishing-the-model)
> [!NOTE]
>
...
In later tutorials, you’ll learn how to [articulate the model](building-a-movable-robot-model-with-urdf.md), [add in some physical properties](adding-physical-and-collision-properties-to-a-urdf-model.md), and [generate neater code with xacro](using-xacro-to-clean-up-a-urdf-file.md), but for now, we’re going to focus on getting the visual geometry correct.

Before continuing, make sure you have the [joint\_state\_publisher](https://index.ros.org/p/joint_state_publisher) package installed.
If you installed [urdf\_tutorial](https://index.ros.org/p/urdf_tutorial) binaries, this should already be the case.
...
[[Source: 01-myfirst.urdf]](https://github.com/ros/urdf_tutorial/blob/ros2/urdf/01-myfirst.urdf)
...
:   - The fixed frame is the transform frame where the center of the grid is located.
      Here, it’s a frame defined by our one link, base\_link.
...
[[Source: 02-multipleshapes.urdf]](https://github.com/ros/urdf_tutorial/blob/ros2/urdf/02-multipleshapes.urdf)
...
- The joint is defined in terms of a parent and a child.
  ...
  This means that the leg’s position is dependent on the base\_link’s position.
...
[[Source: 03-origins.urdf]](https://github.com/ros/urdf_tutorial/blob/ros2/urdf/03-origins.urdf)
...
- If a TF frame does not exist for a given URDF link, then it will be placed at the origin in white
  ([related question](http://answers.ros.org/question/207947/how-do-you-use-externally-defined-materials-in-a-urdfxacro-file/)).

<a id="material-girl"></a>
...
[[Source: 04-materials.urdf]](https://github.com/ros/urdf_tutorial/blob/ros2/urdf/04-materials.urdf)
...
- The body is now blue.
  ...
  This material is then referenced by the base\_link’s visual element.
...
[[Source: 05-visual.urdf]](https://github.com/ros/urdf_tutorial/blob/ros2/urdf/05-visual.urdf)
...
Now you can continue on to the next step, [making it move](building-a-movable-robot-model-with-urdf.md).
