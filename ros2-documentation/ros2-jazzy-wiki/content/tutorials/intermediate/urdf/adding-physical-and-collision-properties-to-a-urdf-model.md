---
title: "Adding physical and collision properties"
docname: "Tutorials/Intermediate/URDF/Adding-Physical-and-Collision-Properties-to-a-URDF-Model"
...
- [Physical Properties](#physical-properties)
  ...
  - [Inertia](#inertia)
  - [Contact Coefficients](#contact-coefficients)
...
[Here is the new urdf](https://raw.githubusercontent.com/ros/urdf_tutorial/ros2/urdf/07-physics.urdf) with collision and physical properties.
...
- This information can be provided to you by modeling programs such as MeshLab.
  The inertia of geometric primitives (cylinder, box, sphere) can be computed using Wikipedia’s [list of moment of inertia tensors](https://en.wikipedia.org/wiki/List_of_moments_of_inertia#List_of_3D_inertia_tensors) (and is used in the above example).
...
<a id="contact-coefficients"></a>

### Contact Coefficients

You can also define how the links behave when they are in contact with one another.
This is done with a subelement of the collision tag called contact\_coefficients.
...
Check out the [spec](https://wiki.ros.org/urdf/XML/joint), as they are not included in this tutorial.

<a id="next-steps"></a>

## Next Steps

Reduce the amount of code and annoying math you have to do by [using xacro](using-xacro-to-clean-up-a-urdf-file.md).
