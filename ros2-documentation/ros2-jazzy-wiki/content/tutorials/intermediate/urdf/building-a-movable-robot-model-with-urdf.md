---
title: "Building a movable robot model"
docname: "Tutorials/Intermediate/URDF/Building-a-Movable-Robot-Model-with-URDF"
...
> Related: [Adding a frame (C++)](../tf2/adding-a-frame-cpp.md) | [Adding a frame (Python)](../tf2/adding-a-frame-py.md) | [Adding physical and collision properties](adding-physical-and-collision-properties-to-a-urdf-model.md) | [Building a visual robot model from scratch](building-a-visual-robot-model-with-urdf-from-scratch.md) | [Creating a launch file](../launch/creating-launch-files.md)

<a id="building-a-movable-robot-model"></a>
<a id="moveableurdf"></a>
...
- [The Gripper Arm](#the-gripper-arm)
- [Other Types of Joints](#other-types-of-joints)
- [Specifying the Pose](#specifying-the-pose)
- [Next steps](#next-steps)

In this tutorial, we’re going to revise the R2D2 model we made in the [previous tutorial](building-a-visual-robot-model-with-urdf-from-scratch.md) so that it has movable joints.
...
See the [previous tutorial](building-a-visual-robot-model-with-urdf-from-scratch.md) for information on what is required.
...
[Here is the new urdf](https://github.com/ros/urdf_tutorial/blob/ros2/urdf/06-flexible.urdf) with flexible joints.
...
<a id="specifying-the-pose"></a>

## Specifying the Pose

As you move the sliders around in the GUI, the model moves in Rviz.
How is this done?
First the [GUI](https://index.ros.org/p/joint_state_publisher_gui) parses the URDF and finds all the non-fixed joints and their limits.
Then, it uses the values of the sliders to publish [sensor\_msgs/msg/JointState](https://github.com/ros2/common_interfaces/blob/eloquent/sensor_msgs/msg/JointState.msg) messages.
Those are then used by [robot\_state\_publisher](https://index.ros.org/p/robot_state_publisher) to calculate all of transforms between the different parts.
...
Now that you have a visibly functional model, you can [add in some physical properties](adding-physical-and-collision-properties-to-a-urdf-model.md), or [start using xacro to simplify your code](using-xacro-to-clean-up-a-urdf-file.md).
