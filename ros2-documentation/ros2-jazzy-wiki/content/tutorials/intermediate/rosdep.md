...
docname: "Tutorials/Intermediate/Rosdep"
...
<a id="managing-dependencies-with-rosdep"></a>

# Managing Dependencies with rosdep

Table of Contents

- [What is rosdep?](#what-is-rosdep)
- [A little about package.xml files](#a-little-about-package-xml-files)

  - [`<depend>`](#depend)
  - [`<build_depend>`](#build-depend)
  - [`<build_export_depend>`](#build-export-depend)
  - [`<exec_depend>`](#exec-depend)
  - [`<test_depend>`](#test-depend)
- [How does rosdep work?](#how-does-rosdep-work)
- [How do I know what keys to put in my package.xml?](#how-do-i-know-what-keys-to-put-in-my-package-xml)
- [What if my library isn’t in rosdistro?](#what-if-my-library-isn-t-in-rosdistro)
- [How do I use the rosdep tool?](#how-do-i-use-the-rosdep-tool)

  - [rosdep installation](#rosdep-installation)
  - [rosdep operation](#rosdep-operation)
...
<a id="a-little-about-package-xml-files"></a>
...
The central index is known as `rosdistro`, which [may be found online](https://github.com/ros/rosdistro).
We’ll explore that more in the next section.

<a id="how-do-i-know-what-keys-to-put-in-my-package-xml"></a>

## How do I know what keys to put in my package.xml?

Great question, I’m glad you asked!

- If the package you want to depend in your package is ROS-based, AND has been released into the ROS ecosystem [[1]](#id2), e.g. `nav2_bt_navigator`, you may simply use the name of the package.
...
<a id="what-if-my-library-isn-t-in-rosdistro"></a>
...
[Detailed instructions may be found here](https://github.com/ros/rosdistro/blob/master/CONTRIBUTING.md#rosdep-rules-contributions) for how to contribute new rosdep keys.
If for some reason these may not be contributed openly, other options exist:

1. Forking rosdistro and maintaining a alternate index containing the extra keys ([Using Custom Rosdistro Version](../../how-to/using-custom-rosdistro.md))
2. Creating a new file containing custom keys and instructing `rosdep` to check it when populating the local index ([Supplementing custom rosdep keys](../advanced/supplementing-custom-rosdep-keys.md))

<a id="how-do-i-use-the-rosdep-tool"></a>

## How do I use the rosdep tool?

<a id="rosdep-installation"></a>
...
“released into the ROS ecosystem” means the package is listed in one or more of the `<distro>/distribution.yaml` directories in the [rosdistro database](https://github.com/ros/rosdistro).
