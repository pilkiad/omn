---
title: "Traveling in time (C++)"
docname: "Tutorials/Intermediate/Tf2/Time-Travel-With-Tf2-Cpp"
...
<a id="traveling-in-time-c"></a>
<a id="timetravelwithtf2cpp"></a>
...
- [Advanced API for lookupTransform()](#advanced-api-for-lookuptransform)
...
In the previous tutorial, we discussed the [basics of tf2 and time](learning-about-tf2-and-time-cpp.md).
...
First, let’s go back to where we ended in the previous tutorial [Using time](learning-about-tf2-and-time-cpp.md).
...
![../../../../_images/turtlesim_delay1.png](../../../../assets/images/turtlesim_delay1.png)
...
1. In our code we asked tf2 the following question: “What was the pose of `carrot1` 5 seconds ago, relative to `turtle2` 5 seconds ago?”.
...
2. However, what we really want to ask is: “What was the pose of `carrot1` 5 seconds ago, relative to the current position of the `turtle2`?”.

<a id="advanced-api-for-lookuptransform"></a>
...
![../../../../_images/turtlesim_delay2.png](../../../../assets/images/turtlesim_delay2.png)
