...
docname: "Tutorials/Beginner-CLI-Tools/Recording-And-Playing-Back-Data/Recording-And-Playing-Back-Data"
...
<a id="recording-and-playing-back-data"></a>
<a id="ros2bag"></a>
...
- [Managing Topic Data](#managing-topic-data)

  - [1 Setup](#setup)
  - [2 Choose a topic](#choose-a-topic)
  - [3 Record topics](#record-topics)
  - [4 Inspect topic data](#inspect-topic-data)
  - [5 Play topic data](#play-topic-data)
- [Managing Service Data](#managing-service-data)

  - [1 Setup](#id1)
  - [2 Check service availability](#check-service-availability)
  - [3 Record services](#record-services)
  - [4 Inspect service data](#inspect-service-data)
  - [5 Play service data](#play-service-data)
- [Summary](#summary)
...
This tutorial talks about concepts covered in previous tutorials, like [nodes](understanding-ros2-nodes.md), [topics](understanding-ros2-topics.md) and [services](understanding-ros2-services.md).
It also uses the [turtlesim package](introducing-turtlesim.md) and [Service Introspection Demo](../demos/service-introspection.md).

As always, don’t forget to source ROS 2 in [every new terminal you open](configuring-ros2-environment.md).

<a id="managing-topic-data"></a>
...
<a id="record-topics"></a>

### 3 Record topics

<a id="record-a-single-topic"></a>
...
![../../../../_images/record.png](../../../assets/images/record.png)
...
![../../../../_images/playback.png](../../../assets/images/playback.png)
...
You can see more details for [Service Introspection Demo](../demos/service-introspection.md).
...
<a id="check-service-availability"></a>
...
The next step is tackling the “Beginner: Client Libraries” tutorials, starting with [Creating a workspace](../beginner-client-libraries/creating-a-workspace.md).

<a id="related-content"></a>

## Related content

A more thorough explanation of `ros2 bag` can be found in the README [here](https://github.com/ros2/rosbag2).
For more information on service recording and playback can be found in the design document [here](https://github.com/ros2/rosbag2/blob/jazzy/docs/design/rosbag2_record_replay_service.md).
For more information on QoS compatibility and `ros2 bag`, see [rosbag2: Overriding QoS Policies](../../how-to/overriding-qo-s-policies-for-recording-and-playback.md).
