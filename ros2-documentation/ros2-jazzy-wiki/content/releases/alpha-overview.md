---
title: "Alphas"
docname: "Releases/Alpha-Overview"
...
> Related: [Ardent Apalone ( ardent )](release-ardent-apalone.md) | [Beta 1 ( Asphalt )](beta1-overview.md) | [Beta 2 ( r2b2 )](beta2-overview.md) | [Beta 3 ( r2b3 )](beta3-overview.md) | [Bouncy Bolson ( bouncy )](release-bouncy-bolson.md)
...
- [ROS 2 alpha8 release (code name *Hook-and-Loop*; October 2016)](#ros-2-alpha8-release-code-name-hook-and-loop-october-2016)

  - [Changes to supported DDS vendors](#changes-to-supported-dds-vendors)
  - [Scope](#scope)
- [ROS 2 alpha7 release (code name *Glue Gun*; July 2016)](#ros-2-alpha7-release-code-name-glue-gun-july-2016)

  - [New version of Ubuntu required](#new-version-of-ubuntu-required)
  - [Scope](#id2)
- [ROS 2 alpha6 release (code name *Fastener*; June 2016)](#ros-2-alpha6-release-code-name-fastener-june-2016)

  - [Scope](#id4)
- [ROS 2 alpha5 release (code name *Epoxy*; April 2016)](#ros-2-alpha5-release-code-name-epoxy-april-2016)

  - [Scope](#id6)
- [ROS 2 alpha4 release (code name *Duct tape*; February 2016)](#ros-2-alpha4-release-code-name-duct-tape-february-2016)

  - [Background](#background)
  - [Status](#status)
  - [Intended audience](#intended-audience)
  - [Scope](#id8)
- [ROS 2 alpha3 release (code name *Cement*; December 2015)](#ros-2-alpha3-release-code-name-cement-december-2015)

  - [Background](#id10)
  - [Status](#id11)
  - [Intended audience](#id12)
  - [Scope](#id13)
- [ROS 2 alpha2 release (code name *Baling wire*; October 2015)](#ros-2-alpha2-release-code-name-baling-wire-october-2015)

  - [Background](#id15)
  - [Status](#id16)
  - [Intended audience](#id17)
  - [Scope](#id18)
- [ROS 2 alpha1 release (code name *Anchor*; August 2015)](#ros-2-alpha1-release-code-name-anchor-august-2015)

  - [Background](#id20)
  - [Status](#id21)
  - [Intended audience](#id22)
  - [Scope](#id23)

This is a merged version of the previously separated pages for the 8 alpha releases of ROS 2.

We hope that you try them out and [provide feedback](../reference/contact.md).

<a id="ros-2-alpha8-release-code-name-hook-and-loop-october-2016"></a>

## ROS 2 alpha8 release (code name *Hook-and-Loop*; October 2016)

<a id="changes-to-supported-dds-vendors"></a>

### Changes to supported DDS vendors

ROS 2 supports multiple middleware implementations (see [this page](../concepts/intermediate/about-different-middleware-vendors.md) for more details).
...
The next steps are described in the [Roadmap](../project/roadmap.md).

<a id="ros-2-alpha7-release-code-name-glue-gun-july-2016"></a>
...
<a id="new-version-of-ubuntu-required"></a>
...
- Graph API functionality: wait\_for\_service
...
<a id="ros-2-alpha6-release-code-name-fastener-june-2016"></a>
...
<a id="ros-2-alpha5-release-code-name-epoxy-april-2016"></a>
...
<a id="ros-2-alpha4-release-code-name-duct-tape-february-2016"></a>
...
As explained in a [design article](https://design.ros2.org/articles/why_ros2.html),
...
To that end, we built a set of [demos](../tutorials/overview.md) that
...
<a id="ros-2-alpha3-release-code-name-cement-december-2015"></a>
...
- Updated `rcl` interface.
  ...
  - See [rcl headers](https://github.com/ros2/rcl/tree/release-alpha3/rcl/include/rcl).
...
<a id="ros-2-alpha2-release-code-name-baling-wire-october-2015"></a>
...
article](https://design.ros2.org/articles/why_ros2.html), we are engaged in
...
articles](https://design.ros2.org).
...
<a id="ros-2-alpha1-release-code-name-anchor-august-2015"></a>
...
- Discovery, transport, and serialization [use DDS](https://design.ros2.org/articles/ros_on_dds.html)
- Support [multiple DDS vendors](https://design.ros2.org/articles/ros_on_dds.html#vendors-and-licensing)
...
- [Use quality-of-service settings to handle lossy networks](../tutorials/demos/quality-of-service.md)
- [Communicate inter-process or intra-process with the same API](../tutorials/demos/intra-process-communication.md)
- [Write real-time safe code that uses the ROS 2 APIs](../tutorials/demos/real-time-programming.md)
