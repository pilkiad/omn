...
docname: "The-ROS2-Project/Contributing/Developer-Guide"
...
> Related: [Add Your Project](../adopters/add-your-project.md) | [Code style and language versions](code-style-language-versions.md) | [Contributing to ROS 2 Documentation](contributing-to-ros-2-documentation.md) | [Quality guide: ensuring code quality](quality-guide.md) | [ROS Build Farms](build-farms.md)

<a id="ros-2-developer-guide"></a>
...
- [General Practices](#general-practices)
  ...
  - [Changes to RMW API](#changes-to-rmw-api)
  - [Tracking tasks](#tracking-tasks)
  - [Package Naming Conventions](#package-naming-conventions)
  - [Units of Measure and Coordinate System Conventions](#units-of-measure-and-coordinate-system-conventions)
  - [Programming conventions](#programming-conventions)
  - [Filesystem layout](#filesystem-layout)
  - [Upstream Packages](#upstream-packages)
- [Developer Workflow](#developer-workflow)

  - [Gitconfig Optimization](#gitconfig-optimization)
- [Architectural Development Practices](#architectural-development-practices)

  - [Software Development Lifecycle](#software-development-lifecycle)
- [Build Farm Introduction](#build-farm-introduction)

  - [Note on Coverage runs](#note-on-coverage-runs)
  - [How to read the coverage rate from the buildfarm report](#how-to-read-the-coverage-rate-from-the-buildfarm-report)
  - [How to calculate the coverage rate from the buildfarm report](#how-to-calculate-the-coverage-rate-from-the-buildfarm-report)
  - [How to measure coverage locally using lcov (Ubuntu)](#how-to-measure-coverage-locally-using-lcov-ubuntu)
...
For more specific code recommendations please see [the Quality Guide](quality-guide.md).

<a id="use-of-generative-ai"></a>

### Use of generative AI

When making contributions of any kind to ROS code or documentation, you must follow the [OSRF Policy](https://osralliance.org/wp-content/uploads/2025/05/OSRF-Policy-on-the-Use-of-Generative-Tools-Generative-AI-in-Contributions.pdf) on the use of generative AI.
...
- We will enforce the [Developer Certificate of Origin (DCO)](https://developercertificate.org/) on pull requests in ROSCore repositories.
  ...
  - DCO is *not* required for pull requests that only address whitespace removal, typo correction, and other [trivial changes](http://cr.openjdk.java.net/~jrose/draft/trivial-fixes.html).
...
<a id="guidelines-for-backporting-prs"></a>
...
- When backporting to older versions, also consider backporting to any other [still supported versions](../../releases/overview.md), even non-LTS versions.
...
<a id="api-documentation-for-ros-packages"></a>

#### API Documentation for ROS Packages

API documentation for all released ROS packages can be [found here](https://docs.ros.org/en/jazzy/p/).
...
If you are a ROS package developer looking for guidance on documenting your package please see [our “how to” guide on package level documentation](../../how-to/documenting-a-ros-2-package.md).
The documentation for all released ROS 2 packages is automatically hosted on [docs.ros.org](https://docs.ros.org/en/jazzy/p/).

<a id="testing"></a>

### Testing

All packages should have some level of [system, integration, and/or unit tests.](../../tutorials/intermediate/testing/testing-main.md#testingmain)
...
<a id="linters-and-static-analysis"></a>

#### Linters and static analysis

We will use [ROS code style](code-style-language-versions.md) and enforce it with linters from [ament\_lint\_common](https://github.com/ament/ament_lint/tree/jazzy/ament_lint_common/doc/index.rst).
All linters/static analysis that are part of `ament_lint_common` must be used.

The [ament\_lint\_auto](https://github.com/ament/ament_lint/blob/jazzy/ament_lint_auto/doc/index.rst) documentation provides information on running `ament_lint_common`.

<a id="general-practices"></a>
...
- Include enough information for another person to understand the issue.
  ...
  - **The DDS/RMW implementation being used** (see [this page](../../concepts/intermediate/about-different-middleware-vendors.md) for how to determine which one).
...
- Mention troubleshooting steps that have been tried already, including:
  ...
  - Upgrading to the latest version of the code, which may include bug fixes that have not been released yet.
    See [this section](../../installation/overview.md#building-from-source) and follow the instructions to get the “rolling” branches.
  - Trying with a different RMW implementation.
    See [this page](../../how-to/working-with-multiple-rmw-implementations.md) for how to do that.
...
`main` typically targets [Rolling](../../releases/release-rolling-ridley.md) (and so, the next unreleased ROS distribution), though the maintainers may decide to develop and release from a `rolling` branch instead.
...
- Only maintainers and committers can merge approved pull requests into the mainline.
  See the [current ROS PMC constituents and committers](../governance.md) for the list of people with merge permissions.

<a id="library-versioning"></a>
...
For more details on recommended software development workflow, see [Software Development Lifecycle](#software-development-lifecycle) section.

<a id="changes-to-rmw-api"></a>
...
<a id="package-naming-conventions"></a>
...
- To check whether a name is taken, consult <https://index.ros.org/packages/>.
...
<a id="units-of-measure-and-coordinate-system-conventions"></a>
...
<a id="programming-conventions"></a>
...
<a id="upstream-packages"></a>

### Upstream Packages

<a id="packages-in-debian-and-ubuntu-upstream"></a>
...
Unlike the OSRF-provided ROS packages from <http://packages.ros.org>, the packages in the upstream repositories are not attached to a specific [ROS distribution](../../releases/overview.md).
...
- Run tests locally using `colcon test` (see the [colcon tutorial](../../tutorials/beginner-client-libraries/colcon-tutorial.md))
...
- If your use case requires running code coverage:
  ...
  - Hit the `build` button
  - At the end of the document there are instructions on how to [interpret the result of the report](#read-coverage-report) and [calculate the coverage rate](#calculate-coverage-rate)
...
<a id="architectural-development-practices"></a>
...
<a id="software-development-lifecycle"></a>
...
<a id="writing-the-design-document"></a>
...
> - Design doc is required and should be contributed to [ros2/design](https://github.com/ros2/design/) to be made accessible on <https://design.ros2.org/>.
...
Before starting, go through the [Pull requests](#pull-requests) section for best practices.
...
- Open a pull request for each modified repository.
  ...
  - Remember to follow [Pull requests](#pull-requests) best practices.
...
<a id="build-farm-introduction"></a>
...
Check [the current set of target platforms and architectures](../../installation/overview.md#binary-package-platforms), though it evolves overtime.
...
For details, frequently asked questions, and troubleshooting see [build farms](build-farms.md).

<a id="note-on-coverage-runs"></a>
...
<a id="how-to-read-the-coverage-rate-from-the-buildfarm-report"></a>
<a id="read-coverage-report"></a>
...
<a id="how-to-calculate-the-coverage-rate-from-the-buildfarm-report"></a>
<a id="calculate-coverage-rate"></a>
...
<a id="how-to-measure-coverage-locally-using-lcov-ubuntu"></a>
<a id="measure-coverage-locally"></a>
