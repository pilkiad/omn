...
> Related: [About ROS](../getting-started/about-ros.md) | [Concepts](../concepts/overview.md) | [Contact](contact.md) | [Distributions](../releases/overview.md) | [First steps with ROS - learning path](../getting-started/first-steps.md)
...
If you use ROS 2 in your work please cite the 2022 Science Robotics paper [Robot Operating System 2: Design, architecture, and uses in the wild](https://www.science.org/doi/10.1126/scirobotics.abm6074).
...
If you use ROS 2 Composition in your work, please cite the 2023 IEEE RA-L paper [Impact of ROS 2 Node Composition in Robotic Systems](https://arxiv.org/abs/2305.09933).
