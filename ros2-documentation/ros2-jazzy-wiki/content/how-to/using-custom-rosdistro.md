---
title: "Using Custom Rosdistro Version"
docname: "How-To-Guides/Using-Custom-Rosdistro"
...
<a id="using-custom-rosdistro-version"></a>
...
- [Overview](#overview)
- [Important Preliminaries](#important-preliminaries)
- [How to Use a Custom Rosdistro Version](#how-to-use-a-custom-rosdistro-version)

<a id="overview"></a>

## Overview

[rosdistro](https://github.com/ros/rosdistro) contains the central index of ROS packages for all distributions and `rosdep` keys for packaged binary dependencies for installation.
...
<a id="important-preliminaries"></a>

## Important Preliminaries

Rosdep populates its cache from the locations set in its `/etc/ros/rosdep/sources.list.d/20-default.list` by default.
When setting up rosdep with `rosdep init`, it populates `20-default.list` with the main rosdistro URLs ([from this file](https://github.com/ros/rosdistro/blob/master/rosdep/sources.list.d/20-default.list)).
...
If you’d like to learn more about this, checkout the [documentation in ros\_buildfarm package](https://github.com/ros-infrastructure/ros_buildfarm/blob/master/doc/custom_rosdistro.rst).

<a id="how-to-use-a-custom-rosdistro-version"></a>
...
You can see this in action in [Nav2’s CircleCI](https://github.com/ros-planning/navigation2/commit/80bb5bff1488c0677efcc4254b7a89908c853ba0) and [ros\_gz’s GitHub Actions](https://github.com/gazebosim/ros_gz/pull/522/files) in order to bypass a temporary Rolling outage in their CI systems.
