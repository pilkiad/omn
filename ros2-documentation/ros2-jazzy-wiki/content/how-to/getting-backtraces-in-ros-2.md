---
title: "Getting Backtraces in ROS 2"
docname: "How-To-Guides/Getting-Backtraces-in-ROS-2"
...
<a id="getting-backtraces-in-ros-2"></a>
...
- [Debugging a specific node with GDB](#debugging-a-specific-node-with-gdb)
- [Reading the Stack Trace](#reading-the-stack-trace)
- [From a Launch File](#from-a-launch-file)
- [From a Large Project](#from-a-large-project)
- [Debugging tests with GDB](#debugging-tests-with-gdb)
...
<a id="debugging-a-specific-node-with-gdb"></a>
...
<a id="reading-the-stack-trace"></a>
...
At this point you can now get a backtrace, and read it using the instructions in [Reading the Stack Trace](#reading-the-stack-trace).

<a id="from-a-large-project"></a>
...
- Launch the node’s launch file in another terminal following the instructions in [From a Launch File](#from-a-launch-file).
...
- Recompile the package of interest with `-g` flag for debug symbols
- Launch the parent launch file in a terminal
- Launch the node in another terminal following the instructions in [Debugging a specific node with GDB](#debugging-a-specific-node-with-gdb).
...
> See [this tutorial](node-arguments.md) for the commandline arguments required.
>
...
<a id="automatic-backtrace-on-crash"></a>

## Automatic backtrace on crash

The [backward-cpp](https://github.com/pal-robotics/backward_ros) library provides beautiful stack traces, and the [backward\_ros](https://github.com/pal-robotics/backward_ros) wrapper simplifies its integration.
