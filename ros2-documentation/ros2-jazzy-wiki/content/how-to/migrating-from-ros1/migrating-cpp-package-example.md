---
title: "Migrating a C++ Package Example"
docname: "How-To-Guides/Migrating-from-ROS1/Migrating-CPP-Package-Example"
...
> Related: [First Time Release](../releasing/first-time-release.md) | [Index Your Packages](../releasing/index-your-packages.md) | [Migrating a Python Package Example](migrating-python-package-example.md) | [Migrating C++ Packages Reference](migrating-cpp-packages.md) | [Migrating Interfaces](migrating-interfaces.md)

<a id="migrating-a-c-package-example"></a>
...
- [Migrating to ROS 2](#migrating-to-ros-2)
  ...
  - [Changing C++ library calls](#changing-c-library-calls)
  - [Change the `package.xml`](#change-the-package-xml)
  - [Changing the CMake code](#changing-the-cmake-code)
  - [Building the ROS 2 code](#building-the-ros-2-code)
  - [Running the ROS 2 node](#running-the-ros-2-node)
...
<a id="changing-c-library-calls"></a>
...
[design document](https://design.ros2.org/articles/qos.html)
and [concept overview](../../concepts/intermediate/about-quality-of-service-settings.md).
...
ROS 2 C++ libraries use [rclcpp](https://index.ros.org/p/rclcpp/#jazzy) instead of [roscpp](https://index.ros.org/p/roscpp/#noetic).
...
<a id="changing-the-cmake-code"></a>
...
Use a newer C++ standard matching the version used by your target ROS distro in [REP 2000](https://reps.openrobotics.org/rep-2000/).
...
<a id="building-the-ros-2-code"></a>
...
Use the [Migrating C++ Packages reference page](migrating-cpp-packages.md) to help you migrate your own C++ packages from ROS 1 to ROS 2.
